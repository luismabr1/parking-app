...
export default function VehicleCapture({ onVehicleDetected, onCancel }: VehicleCaptureProps) {
  ...
  const startCamera = useCallback(async () => {
    ...
    try {
      ...
      await video.play().catch((err) => {
        addDebugInfo(`❌ Error reproduciendo video: ${err}`);
        setError("Error iniciando la cámara. Verifique permisos.");
        stopCamera();
      });
  ...
  }, [addDebugInfo, retryCount, selectedCameraId, stopCamera]);
            ...
            <>
              ...
              {isCapturing && (
                <div className="space-y-4">
                  ...
                  {/* Botones principales debajo del video en vertical */}
                  <div className="space-y-2">
                    <Button
                    ...
                    <Button onClick={() => setUseFileInput(true)} variant="outline" className="w-full" size="lg">
              ...
              {capturedImages[currentStep] && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Button onClick={retakePhoto} variant="outline" className="w-full" size="lg">
                      <RotateCcw className="h-4 w-4 mr-2" />
                      Retomar
                    </Button>
                    {currentStep === "vehicle" && (
